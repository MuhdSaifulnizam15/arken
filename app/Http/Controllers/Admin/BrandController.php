        ...
        if($request->ajax()){
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($data){
                        $btn = '<a class="btn btn-outline-primary m-1" href="'. route("admin.brands.edit", $data->id) .'"><i class="fa fa-edit"></i></a>';
                        $btn .=  '<a href="'. route("admin.brands.delete", $data->id) .'" class="btn btn-outline-danger m-1"><i class="fa fa-trash"></i></a>';
                        return $btn;
                    })
                    ->rawColumns(['action'])
                    ->make(true);
